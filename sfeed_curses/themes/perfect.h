...
#define THEME_SCROLLBAR_FOCUS()       do { ttywrite("\x1b[37m");    } while(0) /* blue fg */
#define THEME_SCROLLBAR_NORMAL()      do { ttywrite("\x1b[37m");    } while(0)
...
#define THEME_LINEBAR()               do { ttywrite("\x1b[37m");    } while(0)
...
#define THEME_PANE_FEEDS()            do { ttywrite("\x1b[40m");    } while(0)
